...
**AI / ML**
`Python` `PyTorch` `YOLOv8` `OpenCV` `Federated Learning` `Differential Privacy` `Homomorphic Encryption` `CRNN` `Streamlit`
...
|---|---|---|
| [Privacy-Preserving ALPR](https://github.com/Kushal09-bit/Privacy-Preserving-ALPR) | Federated license plate recognition with DP + HE | PyTorch, YOLOv8, TenSEAL |
...
[![Email](https://img.shields.io/badge/Email-Reach%20Out-red?style=flat&logo=gmail)](mailto:your-email-here)
